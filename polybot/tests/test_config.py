...
class TestValidateConfigPasses:
    ...
    def test_boundary_low_values(self):
        ...
        _set_nested(cfg, "signal.entry_threshold", 0.05)
    ...
    def test_boundary_high_values(self):
        ...
        _set_nested(cfg, "signal.entry_threshold", 0.35)
...
class TestValidateConfigOutOfRange:
    @pytest.mark.parametrize("key, bad_value, expected_fragment", [
        ...
        # signal scalars
        ("signal.entry_threshold", 0.04, "not in [0.05, 0.35]"),
        ("signal.entry_threshold", 0.40, "not in [0.05, 0.35]"),
        ...
        ("signal.momentum_weight", 0.01, "not in [0.02, 0.1]"),
        ("signal.momentum_weight", 0.15, "not in [0.02, 0.1]"),

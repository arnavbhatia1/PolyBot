...
| k_place **[6,25]** (58 tried 09-04→09-08, reverted) | settings | 09-08 | r24 (0 flip-fills at every k_max in 18 replay days) was contradicted live within 3 days: 09-07 01:15Z ep 1788743700 armed at k=49 on disp +$53.94 (3× the floor), filled 0.80/0.65/0.50 in 0.6 s as the book dumped Up, closed Down by $7.2 — a $61 projection error at k=49 (2× the p99.5 knot), −$77.22, 19% of bankroll. The pre-registered clause fired; 25 has 0 flips in replay AND live | extended-corpus replay incl. September (ws1_reduce/ws2 DAYS → 09-07) re-derives the frontier before any re-widening; the loss window must be a flip-fill in that replay or the replay is not engine-true |
